def dicts_to_str (list_dicts):
    str = []
    for dict_item in list_dicts:
        str_title = f'{dict_item['title']}\n'
        str.append(str_title)
        chapters = dict_item['chapters']
        for chapter in chapters:
            str_chapter = f'* {chapter['title']}\n'
            str.append(str_chapter)
    return ''.join(str)
